...
class FamilyAnualCombo extends StatelessWidget {
  final String size;

  const FamilyAnualCombo({Key key, @required this.size}) : super(key: key);
    ...
    if (size == "size1") {
      ...
      return Column(
        children: [
          Container(
              child: Image.asset(
            "lib/assets/familyanual",
            height: 400,
            width: screenSize.width,
          )),
          Text("COMBO MY FAMILY CINEMA+TV EXPRESS 365 DIAS e",
              style: TextStyle(fontWeight: FontWeight.bold)),
          Text("Entrega Garantida do Produto.",
              style: TextStyle(fontWeight: FontWeight.bold)),
          SizedBox(height: 16),
